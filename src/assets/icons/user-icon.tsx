...
const UserIcon = () => {
    return (
        <svg id='outline-people-24px' xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
            <path id='Path_11387' data-name='Path 11387' d='M0,0H24V24H0Z' fill='none' />
